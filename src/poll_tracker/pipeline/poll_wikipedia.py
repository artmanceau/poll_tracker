...
if __name__ == "__main__":
    ...
    for year in config['years']:
        ...
        for tour in ['t1', 't2']:
            datasets[tour].write_parquet(config['data_path'] + f"{election_type}/{year}/{tour}/polls.parquet",
            storage_options={
        ...
        events.write_parquet(config['data_path'] + f"{election_type}/{year}/events.parquet",
            storage_options={
                "aws_endpoint_url": "https://minio.lab.sspcloud.fr",
                "aws_region": "us-east-1",
            },
